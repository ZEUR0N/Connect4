...
class App: public Singleton<App> {
	...
	friend Singleton<App> ; // needed to give access to private constructors
...
private:
	App();
	App(std::string windowTitle, int width, int height);
...
// This macro defines a compact way for using the singleton App, instead of
// writing App::instance()->method() we write App().method()
//
inline App& app() {
	return *App::instance();
}